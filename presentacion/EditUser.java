...
public class EditUser extends javax.swing.JFrame {
    ...
    public EditUser( ControladoraNegocio control, int userId) {
        initComponents();
    ...
    private void initComponents() {
        ...
        btnEdit.setBackground(new java.awt.Color(1, 135, 71));
        btnEdit.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        btnEdit.setForeground(new java.awt.Color(255, 255, 255));
        btnEdit.setIcon(new javax.swing.ImageIcon("C:\\Users\\Matias Altamiranda\\Downloads\\icono\\IconosForLogin\\iloveimg-resized (1)\\usuario-Editar.png")); // NOI18N
        btnEdit.setText("Editar");
        btnEdit.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(1, 135, 71), 1, true));
        ...
        jLabel5.setText("Estas por editar los datos de un usuario existente");
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
        ...
        control.editUser(usu,usuario, pass, rol);
        JOptionPane optionPane = new JOptionPane("El usuario se edito correctamente");
        optionPane.setMessageType(JOptionPane.INFORMATION_MESSAGE);
        JDialog dialog = optionPane.createDialog("Exito al editar");
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        txtNameUser.setText(usu.getUserName());
        ...
        String rol = usu.getUnRol().getTipoRol();
